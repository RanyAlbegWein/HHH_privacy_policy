...
Welcome to HHH! We respect your privacy and are committed to protecting your personal information. This Privacy Policy explains how we collect, use, and protect your data.
...
- **Usage Data:** Technical information about app usage to improve our service.

## 2. How We Use Your Information

We use the collected information for the following purposes:

- Operating the app and providing its services
- Identifying and displaying your profile to other users
- Improving user experience and the app
- Sending notifications about relevant activity (new followers, responses to jokes)
- Preventing abuse and protecting the community
...
- Use of Google's secure Firebase services
- Encrypted communication via HTTPS
- Access to information limited to what is necessary
